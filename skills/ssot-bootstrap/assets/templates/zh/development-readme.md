...
|---|---|---|---|---|
| 如何启动本地开发？ | [本地运行](#本地运行) | this file | package.json / Makefile / Dockerfile / docs | |
| 哪些脚本/工具常用且有前置条件？ | [脚本 / 工具目录](#脚本--工具目录) | scripts directory | scripts directory / CI / Makefile | |
| 新增功能时遵守哪些代码模式？ | [模式语言](#模式语言) | this file | code review / lint config / examples | |
